...
export namespace ActionManager {
    export function start_action_targeted(action: ActionTargeted, char: Character, data: [number, number]) {
    ...
    function action_targeted(action: ActionTargeted, char: Character, data: [number, number]): CharacterActionResponce {
