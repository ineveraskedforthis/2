...
type ActionCheckFunction = ((pool: PgPool, char: Character, data: any) => Promise<CharacterActionResponce>) 
type ActionFunction = ((pool: PgPool, char: Character, data: any) => any)
...
export class ActionManager {
    ...
    async start_action(action_id: CharacterAction, char: Character, data: any) {
    ...
    async action(action_id: CharacterAction, char: Character, data: any): Promise<CharacterActionResponce> {
        let action = this.actions[action_id];
