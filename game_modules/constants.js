const constants = {
    ...
    new_battle_query: 'INSERT INTO battles (id, ids, teams, positions, savings, stash) VALUES ($1, $2, $3, $4, $5, $6)',
    ...
    new_market_order_query: 'INSERT INTO market_orders (id, typ, tag, owner_id, owner_tag, amount, price, market_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)',
    insert_market_order_query: 'INSERT INTO market_orders (id, typ, tag, owner_id, owner_tag, amount, price, market_id) VALUES ( default, $1, $2, $3, $4, $5, $6, $7) RETURNING id',
