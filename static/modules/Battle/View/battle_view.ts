...
export class BattleView {
    ...
    static get player_position() : canvas_position|undefined {
        ...
        if (!this._player_view.valid) return undefined
    ...
    static get selected_position() : canvas_position|undefined {
        ...
        if (!this._selected_view.valid) return undefined
    ...
    static get hovered_position() : canvas_position|undefined {
        ...
        if (!this._hovered_view.valid) return undefined
    ...
    static get current_turn_position() : canvas_position|undefined {
        ...
        if (!this._current_turn_view.valid) return undefined
    ...
    static draw_current_turn() {
        ...
        if (!unit.valid) this._current_turn_view = undefined
    ...
    static draw_player() {
        ...
        if (unit == undefined) return
        if (!unit.valid) this._player_view = undefined
