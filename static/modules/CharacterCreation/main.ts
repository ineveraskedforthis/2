...
export function set_up_character_creation_UI(socket: Socket) {
...
function set_faction(faction: string) {
    ...
    if (faction == 'city') race = 'human';
    if (faction == 'steppe_humans') race = 'human';
    if (faction == 'big_humans') race = 'human_strong';
    if (faction == 'rats') race = 'bigrat';
...
function hover_faction(faction: string) {
