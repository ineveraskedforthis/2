import { display_layers } from "./equip_strings.js";
import { WeaponConfiguration, ArmourConfiguration } from "../.././content.js";
...
export function load(gl) {
    ...
    gl.vertexAttribPointer(attribute_location, numComponents, type, normalize, stride, offset);
...
export function update_rects(r) {
...
export function render(r, objects, perspective, view) {
