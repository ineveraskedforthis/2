...
let market_div_buy = document.getElementById('goods_list_buy')! as HTMLDivElement;
let market_div_sell = document.getElementById('goods_list_sell')! as HTMLDivElement;
