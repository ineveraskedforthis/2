...
export function tired(character: Character) {
    return (character.get_fatigue() > ScriptedValue.rest_target_fatigue(3, 0, character.race()) + 10) 
        || (character.get_stress()  > ScriptedValue.rest_target_stress(3, 0, character.race()) + 10);
}
