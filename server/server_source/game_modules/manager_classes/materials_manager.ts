...
export const FISH = materials.create_material(3, 1, 'fish')
export const COTTON = materials.create_material(1, 1, 'cotton')
export const TEXTILE = materials.create_material(1, 3, 'textile')
