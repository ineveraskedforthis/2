...
export const RAT_SKIN = materials.create_material(0.2, 2, 'rat_skin')
export const RAT_BONE = materials.create_material(0.3, 5, 'rat_bone')
...
export const WOOD = materials.create_material(0.5, 3, 'wood')
...
export const COTTON = materials.create_material(0.1, 1, 'cotton')
export const TEXTILE = materials.create_material(0.1, 3, 'textile')
