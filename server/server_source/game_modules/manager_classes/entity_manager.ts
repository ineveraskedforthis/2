...
//      init() {
//          this.init_cells(pool);
//     }

//      load() {
//          this.load_cells(pool)
//          this.load_characters(pool);
//          this.load_orders(pool);
//          this.load_item_orders(pool);
//          this.load_battles(pool);
//          this.load_areas(pool);
//          this.load_factions(pool);
//          this.load_quests(pool);
//          this.clear_dead_orders(pool);
//     }

//      load_characters() {
//         let res =  common.send_query(pool, constants.load_chars_query);
...
//      load_orders() {
//         let res =  common.send_query(pool, constants.load_orders_query);
//         for (let i of res.rows) {
...
//      load_item_orders() {
//         let res =  common.send_query(pool, constants.load_item_orders_query);
//         for (let i of res.rows) {
...
//      load_battles() {
//         let res =  common.send_query(pool, constants.load_battles_query);
//         for (let i of res.rows) {
...
//      load_areas() {
//         let res =  common.send_query(pool, constants.load_areas_query);
//         for (let i of res.rows) {
...
//      load_factions() {
//         let res =  common.send_query(pool, constants.load_factions_query);
//         for (let i of res.rows) {
...
//      load_quests() {
//         let res =  common.send_query(pool, constants.load_quests_query);
//         for (let i of res.rows) {
...
//                 if (!char.in_battle()) {
//                      char.update(pool, dt);
//                     if (decision_flag) { this.world.ai_manager.decision(pool, char)}
...
//             let test_rat =  this.create_new_character(pool, 'Mr. Rat ' + i, this.get_cell_id_by_x_y(9, 9), -1)
//              rat(pool, test_rat)
//         }

//         for (let i = elos; i < 40; i++) {
//             let test_rat =  this.create_new_character(pool, 'Mr. Elo ' + i, this.get_cell_id_by_x_y(18, 7), -1)
//              elo(pool, test_rat)
//         }
//     }
...
//                 //      this.new_quest(pool, leader, 'meat', quest_money_reward, quest_reputation_reward)
//                 // }
//             }
//         }
//     }
...
//         // let quest =  this.create_quest(pool, item_tag, money_reward, reputation_reward);
...
//         let order = new MarketOrder(this.world)
//          order.init(pool, typ, tag, owner, amount, price, cell_id)
...
//              this.remove_order(pool, order_id)
//         }
...
//         let char = new Character(this.world);
//          char.init(pool, name, cell_id, user_id);
...
//         let quest = new Quest(this.world)
//         let id =  quest.init(pool, item, reward_money, reward_reputation)
