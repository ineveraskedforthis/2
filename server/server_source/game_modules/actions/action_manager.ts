...
import { craft_bone_armour, craft_elo_dress, craft_graci_hair, craft_rat_armour, craft_rat_boots, craft_rat_gloves, craft_rat_helmet, craft_rat_pants } from "./actions_set_up/character_actions/craft_armour"
...
export namespace CharacterAction {
    ...
    export namespace CRAFT {
        ...
        export const BONE_ARMOUR = craft_bone_armour
    }    
}
