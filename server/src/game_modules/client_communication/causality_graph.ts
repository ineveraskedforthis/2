...
const children:{[_ in UI_Part]?: UI_Part[]} = {
    [UI_Part.ROOT]                      : [ UI_Part.STATUS,
                                            ...
                                            UI_Part.MARKET,
                                            UI_Part.STATS],
        [UI_Part.STATUS]                : [ UI_Part.HP, UI_Part.FATIGUE, UI_Part.STRESS, UI_Part.RAGE, UI_Part.BLOOD],
...
const update_function: {[_ in UI_Part]: ((user: User) => void)} = {
    [UI_Part.ROOT]                          : SendUpdate.all,
        [UI_Part.STATUS]                    : SendUpdate.status,
            ...
            [UI_Part.BLOOD]                 : SendUpdate.blood,
            [UI_Part.STRESS]                : SendUpdate.stress,
            [UI_Part.FATIGUE]               : SendUpdate.fatigue,
            [UI_Part.RAGE]                  : SendUpdate.rage,
