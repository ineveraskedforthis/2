...
export type BattleActionExecution = (battle: Battle, character: Character, ) => void
...
export type BattleActionExecutionPosition = (battle: Battle, character: Character, target: battle_position) => void
...
export type BattleActionExecutionTarget = (battle: Battle, character: Character, target_character: Character,  ignore_flag?: boolean) => void