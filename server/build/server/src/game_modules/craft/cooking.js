...
(function (Cooking) {
    ...
    Cooking.berries = (0, CraftBulk_1.new_craft_bulk)('berry_to_zaz', [{ material: 29 /* MATERIAL.BERRY_ZAZ */, amount: 20 }], [{ material: 30 /* MATERIAL.ZAZ */, amount: 1 }], [{ skill: 'cooking', difficulty: 20 }, { skill: 'magic_mastery', difficulty: 40 }]);
