...
(function (Cooking) {
    ...
    Cooking.meat2 = (0, CraftBulk_1.new_craft_bulk)('meat_to_food', [{ material: 22 /* MATERIAL.MEAT_HUMAN */, amount: 2 }], [{ material: 24 /* MATERIAL.MEAT_HUMAN_FRIED */, amount: 1 }], [{ skill: 'cooking', difficulty: 20 }]);
    Cooking.meat3 = (0, CraftBulk_1.new_craft_bulk)('meat_to_food', [{ material: 23 /* MATERIAL.MEAT_GRACI */, amount: 2 }], [{ material: 25 /* MATERIAL.MEAT_GRACI_FRIED */, amount: 1 }], [{ skill: 'cooking', difficulty: 20 }]);
