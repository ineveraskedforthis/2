...
(function (DataID) {
    ...
    (function (Cells) {
        ...
        function local_character_id_list(cell) {
            ...
            locations(cell).forEach((location) => {
                result.concat(Location.guest_list(location));
            });
            return result;
        }
        ...
        function market_order_id_list(cell) {
            ...
            local_character_id_list(cell).forEach((character) => {
                result.concat(Array.from(character_id_owned_market_order_set[character]));
            });
            return result;
        }
    ...
    (function (Location) {
        ...
        function new_id(cell) {
            last_id_location++;
            location_id_list.push(last_id_location);
            let cell_location_list = cell_id_location_id_list[cell];
            cell_location_list.push();
            location_id_cell[last_id_location] = cell;
            return last_id_location;
        }
    ...
    let Faction;
    (function (Faction) {
        function register(faction_id, data) {
            faction_id_list.push(faction_id);
            factions_list[faction_id] = data;
        }
