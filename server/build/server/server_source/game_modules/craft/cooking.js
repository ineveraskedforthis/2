...
var Cooking;
(function (Cooking) {
    Cooking.meat = (0, CraftBulk_1.new_craft_bulk)('meat_to_food', [{ material: materials_manager_1.MEAT, amount: 1 }], [{ material: materials_manager_1.FOOD, amount: 1 }], [{ skill: 'cooking', difficulty: 10 }]);
    Cooking.fish = (0, CraftBulk_1.new_craft_bulk)('fish_to_food', [{ material: materials_manager_1.FISH, amount: 1 }], [{ material: materials_manager_1.FOOD, amount: 1 }], [{ skill: 'cooking', difficulty: 10 }]);
